...
const LandingPage = () => {
  ...
  return (
    <>
      ...
      >
        {/* header */}
        <div className="h-[10vh] w-full pl-4 sm:pl-6 md:pl-8 md:flex-end lg:flex lg:flex-end  flex justify-between items-center">
          <RxHamburgerMenu
            size={25}
            color="white"
        ...
        >
          {
            landingHeaderLinks.map((items) => (
              <>
                <Link to={items.link}
                  key={items.id} className="flex pl-4 py-1 pt-2 font-bold cursor-pointer hover:bg-gray-100 hover:rounded-lg">
